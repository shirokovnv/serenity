...
class OceanRenderer(private val params: OceanParams): Behaviour(), Renderer {
    companion object {
    ...
    private fun renderFft(shader: OceanFftShader, texType: OceanTextureType) {
        ...
        while (count >= 1) {
            ...
            // DRAW ??
            GL42.glBindImageTexture(0, texInitializer.getTexture(texType).getId(), 0, false, 0, GL15.GL_READ_ONLY, GL30.GL_RGBA32F)
