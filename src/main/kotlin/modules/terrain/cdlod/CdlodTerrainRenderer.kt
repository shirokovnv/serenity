...
class CdlodTerrainRenderer(
    private val terrain: CdlodTerrainSystem,
    private val buffer: CdlodTerrainBuffer,
    private val shader: CdlodTerrainShader,
    private val material: CdlodTerrainMaterial
    ...
    override fun render(pass: RenderPass) {
        ...
        val lodVectors = FloatArray(numInstances) { 0.0f }
